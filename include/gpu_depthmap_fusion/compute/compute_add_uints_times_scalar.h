...
// out = in_a + in_b * multiplier
class ComputeAddUintsTimesScalar : public ComputeProgram
{
public:
    virtual ~ComputeAddUintsTimesScalar() {}
        ...
        uint bufbind_out)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "add_uints_times_scalar.glsl", {
