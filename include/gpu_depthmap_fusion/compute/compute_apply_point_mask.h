...
class ComputeApplyPointMask : public ComputeProgram
{
public:
    virtual ~ComputeApplyPointMask() {}
        ...
        uint bufbind_scratchpad)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "apply_point_mask.glsl", {
        ...
        out_point_offset.init(m_glProgram, "out_point_offset");
