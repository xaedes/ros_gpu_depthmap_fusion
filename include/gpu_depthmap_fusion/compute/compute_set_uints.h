...
class ComputeSetUints : public ComputeProgram
{
public:
    virtual ~ComputeSetUints() {}
        ...
        uint bufbind_out)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "set_uints.glsl", {
