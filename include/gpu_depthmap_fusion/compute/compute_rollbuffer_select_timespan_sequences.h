...
class ComputeRollbufferSelectTimespanSequences : public ComputeProgram
{
public:
    virtual ~ComputeRollbufferSelectTimespanSequences() {}
        ...
        uint bufbind_in_sequences)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "rollbuffer_select_timespan_sequences.glsl", {
