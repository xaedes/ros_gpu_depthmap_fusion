...
class ComputeRollbufferCountDiscardedPoints : public ComputeProgram
{
public:
    virtual ~ComputeRollbufferCountDiscardedPoints() {}
        ...
        uint bufbind_scratchpad)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "rollbuffer_count_discarded_points.glsl", {
