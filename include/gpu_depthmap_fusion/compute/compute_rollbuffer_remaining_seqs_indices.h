...
class ComputeRollbufferRemainingSeqsIndices : public ComputeProgram
{
public:
    virtual ~ComputeRollbufferRemainingSeqsIndices() {}
        ...
        uint bufbind_out_indices)
    {
        ...
        m_groupsize_y = 1;
        m_groupsize_z = 1;        
        ComputeProgram::init(shader_path + "rollbuffer_remaining_seqs_indices.glsl", {
