...
// rollbuffer_select_timespan_sequences
...
void main()
{
    ...
    uint t_sec = in_sequences[in_sequences_offset + global_idx].timestampSec;
    uint t_nsec = in_sequences[in_sequences_offset + global_idx].timestampNSec;
